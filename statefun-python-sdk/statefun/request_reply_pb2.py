...
_FROMFUNCTION_MISSINGPERSISTEDVALUE_EXPIREMODE = _descriptor.EnumDescriptor(
  name='ExpireMode',
  full_name='org.apache.flink.statefun.flink.core.polyglot.FromFunction.MissingPersistedValue.ExpireMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_FROMFUNCTION_MISSINGPERSISTEDVALUE_EXPIREMODE)
...
_FROMFUNCTION_MISSINGPERSISTEDVALUE = _descriptor.Descriptor(
  name='MissingPersistedValue',
  full_name='org.apache.flink.statefun.flink.core.polyglot.FromFunction.MissingPersistedValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='state_name', full_name='org.apache.flink.statefun.flink.core.polyglot.FromFunction.MissingPersistedValue.state_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expire_mode', full_name='org.apache.flink.statefun.flink.core.polyglot.FromFunction.MissingPersistedValue.expire_mode', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expire_after_millis', full_name='org.apache.flink.statefun.flink.core.polyglot.FromFunction.MissingPersistedValue.expire_after_millis', index=2,
  ...
  nested_types=[],
  enum_types=[
    _FROMFUNCTION_MISSINGPERSISTEDVALUE_EXPIREMODE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_FROMFUNCTION_RETRYINVOCATIONREQUEST = _descriptor.Descriptor(
  name='RetryInvocationRequest',
  full_name='org.apache.flink.statefun.flink.core.polyglot.FromFunction.RetryInvocationRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='missing_values', full_name='org.apache.flink.statefun.flink.core.polyglot.FromFunction.RetryInvocationRequest.missing_values', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FROMFUNCTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='retry_request', full_name='org.apache.flink.statefun.flink.core.polyglot.FromFunction.retry_request', index=1,
  ...
  nested_types=[_FROMFUNCTION_PERSISTEDVALUEMUTATION, _FROMFUNCTION_INVOCATION, _FROMFUNCTION_DELAYEDINVOCATION, _FROMFUNCTION_EGRESSMESSAGE, _FROMFUNCTION_INVOCATIONRESPONSE, _FROMFUNCTION_MISSINGPERSISTEDVALUE, _FROMFUNCTION_RETRYINVOCATIONREQUEST, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_FROMFUNCTION_MISSINGPERSISTEDVALUE.fields_by_name['expire_mode'].enum_type = _FROMFUNCTION_MISSINGPERSISTEDVALUE_EXPIREMODE
_FROMFUNCTION_MISSINGPERSISTEDVALUE.containing_type = _FROMFUNCTION
_FROMFUNCTION_MISSINGPERSISTEDVALUE_EXPIREMODE.containing_type = _FROMFUNCTION_MISSINGPERSISTEDVALUE
_FROMFUNCTION_RETRYINVOCATIONREQUEST.fields_by_name['missing_values'].message_type = _FROMFUNCTION_MISSINGPERSISTEDVALUE
_FROMFUNCTION_RETRYINVOCATIONREQUEST.containing_type = _FROMFUNCTION
_FROMFUNCTION.fields_by_name['invocation_result'].message_type = _FROMFUNCTION_INVOCATIONRESPONSE
_FROMFUNCTION.fields_by_name['retry_request'].message_type = _FROMFUNCTION_RETRYINVOCATIONREQUEST
...
_FROMFUNCTION.oneofs_by_name['response'].fields.append(
  _FROMFUNCTION.fields_by_name['retry_request'])
_FROMFUNCTION.fields_by_name['retry_request'].containing_oneof = _FROMFUNCTION.oneofs_by_name['response']
...
FromFunction = _reflection.GeneratedProtocolMessageType('FromFunction', (_message.Message,), {
  ...
  'MissingPersistedValue' : _reflection.GeneratedProtocolMessageType('MissingPersistedValue', (_message.Message,), {
    'DESCRIPTOR' : _FROMFUNCTION_MISSINGPERSISTEDVALUE,
    '__module__' : 'request_reply_pb2'
    # @@protoc_insertion_point(class_scope:org.apache.flink.statefun.flink.core.polyglot.FromFunction.MissingPersistedValue)
    })
  ,

  'RetryInvocationRequest' : _reflection.GeneratedProtocolMessageType('RetryInvocationRequest', (_message.Message,), {
    'DESCRIPTOR' : _FROMFUNCTION_RETRYINVOCATIONREQUEST,
    '__module__' : 'request_reply_pb2'
    # @@protoc_insertion_point(class_scope:org.apache.flink.statefun.flink.core.polyglot.FromFunction.RetryInvocationRequest)
    })
  ,
...
_sym_db.RegisterMessage(FromFunction.MissingPersistedValue)
_sym_db.RegisterMessage(FromFunction.RetryInvocationRequest)

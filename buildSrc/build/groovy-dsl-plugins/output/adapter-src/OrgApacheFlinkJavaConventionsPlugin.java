...
/**
 * Precompiled org.apache.flink.java-conventions script plugin.
 **/
public class OrgApacheFlinkJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgApacheFlinkJavaConventions").asSubclass(BasicScript.class);

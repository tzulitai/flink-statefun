...
/**
 * Precompiled org.apache.flink.statefun.java-protobuf-conventions script plugin.
 **/
public class OrgApacheFlinkStatefunJavaProtobufConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgApacheFlinkStatefunJavaProtobufConventions").asSubclass(BasicScript.class);

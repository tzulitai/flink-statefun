...
from statefun import StatefulFunctions, PersistedValue, Expiration, kafka_egress_record
...
@functions.bind(
    ...
    persisted_values=[ PersistedValue("counter") ])
...
@functions.bind(
    ...
    persisted_values=[
        PersistedValue("counter"),
        PersistedValue("missing-state-1"),
        PersistedValue("missing-state-2", state_ttl=Expiration(10000)),
        PersistedValue("missing-state-3", state_ttl=Expiration(2000, expire_mode=Expiration.Mode.AFTER_WRITE)) ])

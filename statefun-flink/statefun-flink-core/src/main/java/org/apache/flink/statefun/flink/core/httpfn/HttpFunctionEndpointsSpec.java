...
import org.apache.flink.statefun.flink.core.jsonmodule.FunctionEndpointsSpec;

public final class HttpFunctionEndpointsSpec implements FunctionEndpointsSpec {
  ...
  private HttpFunctionEndpointsSpec(
  ...
  public static Builder builder(TargetType targetType, UrlPathTemplate urlPathTemplate) {
    return new Builder(targetType, urlPathTemplate);
  }
  ...
  public static final class Builder {
    ...
    private Builder(TargetType targetType, UrlPathTemplate urlPathTemplate) {
    ...
    public HttpFunctionEndpointsSpec build() {
      validateTimeouts();

      return new HttpFunctionEndpointsSpec(
          targetType,
          urlPathTemplate,
          maxRequestDuration,
          connectTimeout,

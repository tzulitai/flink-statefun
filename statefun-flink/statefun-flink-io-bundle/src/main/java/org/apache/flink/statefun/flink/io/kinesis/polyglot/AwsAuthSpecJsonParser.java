...
final class AwsAuthSpecJsonParser {
  ...
  static Optional<AwsRegion> optionalAwsRegion(JsonNode awsRegionSpecNode) {
  ...
  static Optional<AwsCredentials> optionalAwsCredentials(JsonNode awsCredentialsSpecNode) {

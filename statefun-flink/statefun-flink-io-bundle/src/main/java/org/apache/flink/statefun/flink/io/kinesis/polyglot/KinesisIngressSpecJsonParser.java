...
final class KinesisIngressSpecJsonParser {
  ...
  private static final JsonPointer AWS_REGION_POINTER =
      JsonPointer.compile("/ingress/spec/awsRegion");
  private static final JsonPointer AWS_CREDENTIALS_POINTER =
      JsonPointer.compile("/ingress/spec/awsCredentials");

  private static final JsonPointer STREAMS_POINTER = JsonPointer.compile("/ingress/spec/streams");
  ...
  private static final JsonPointer CLIENT_CONFIG_PROPS_POINTER =
      JsonPointer.compile("/ingress/spec/clientConfigProperties");
  ...
  static Optional<AwsRegion> optionalAwsRegion(JsonNode ingressSpecNode) {
    return AwsAuthSpecJsonParser.optionalAwsRegion(ingressSpecNode.at(AWS_REGION_POINTER));
  }

  static Optional<AwsCredentials> optionalAwsCredentials(JsonNode ingressSpecNode) {
    return AwsAuthSpecJsonParser.optionalAwsCredentials(
        ingressSpecNode.at(AWS_CREDENTIALS_POINTER));
  }
